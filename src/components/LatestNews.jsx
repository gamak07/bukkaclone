...
const LatestNews = () => {
  return (
    <div className='bg-graylight'>
        <h1 className='text-4xl font-bold font-philosopher text-center'>Latest news</h1>
        <div className='flex justify-center gap-4 mt-10 pb-10'>
            <div className='bg-white flex flex-col w-80 p-4'>
                <img src={NewsOne} alt="" />
                <p className='capitalize font-philosopher text-xl'>Lorem ipsum dolor sit amet</p>
                <p className='text-xs font-poppins leading-[20px]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi dolores at commodi ullam doloribus expedita similique eum facilis libero quibusdam, repellendus vero explicabo dicta perspiciatis vel numquam illum nisi a ex, dolorem quos. Laboriosam soluta alias vero! Dolorum aliquam veritatis atque eligendi debitis iure aspernatur magnam, molestias facere placeat ipsa?</p>
            </div>
            <div className='bg-white flex flex-col w-80 p-4'>
                <img src={NewsTwo} alt="" /> 
                <p className='capitalize font-philosopher text-xl '>Lorem ipsum dolor sit amet</p> 
                <p className='text-xs font-poppins leading-[20px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam libero amet aut accusamus quis? Quo reprehenderit repudiandae totam aspernatur et, amet neque quod hic saepe?</p>
            </div>
            <div className='bg-white flex flex-col w-80 p-4'>
